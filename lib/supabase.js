...
Automações WhatsApp (Z-API) - requer variáveis de ambiente só de servidor (NUNCA prefixo NEXT_PUBLIC_):
  ZAPI_INSTANCE, ZAPI_TOKEN, ZAPI_CLIENT_TOKEN, SUPABASE_SERVICE_ROLE_KEY, CRON_SECRET
